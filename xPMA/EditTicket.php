...
$materialToOfficeServices = (!empty(filter_input(INPUT_POST,'material_to_office_services')))?filter_input(INPUT_POST,"material_to_office_services"):null;

$chargeCode = (!empty(filter_input(INPUT_POST,'charge_code')))?filter_input(INPUT_POST,"charge_code"):null;
$quantity = (!empty(filter_input(INPUT_POST,'quantity')))?filter_input(INPUT_POST,"quantity"):null;
