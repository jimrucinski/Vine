...
CREATE TABLE "ArchivedVersions"(
	...
	"ArchivedBy" NVARCHAR2(50) NULL,
 CONSTRAINT "PK_ArchivedVersions" PRIMARY KEY  
(
	"VersionId"
) 
) 
...
CREATE TABLE "History"(
	...
	"TaskStack" NCLOB NULL,
	"AdditionalInfo" NCLOB NULL,
	"Created" TIMESTAMP(3) NOT NULL
) 
...
CREATE TABLE "Links"(
	...
	"SourceLanguage" NVARCHAR2(50) NULL,
	"SourceVersion" NUMBER(10,0) NOT NULL,
	"SourceFieldID" CHAR(32) NOT NULL,
	"TargetDatabase" NVARCHAR2(50) NULL,
	"TargetItemID" CHAR(32) NOT NULL,
	"TargetLanguage" NVARCHAR2(50) NULL,
	"TargetPath" NCLOB NULL,
	"TargetVersion" NUMBER(10,0) NOT NULL
)  
...
/
ALTER TABLE "Blobs" MODIFY "Id" DEFAULT (SYS_GUID())
/
ALTER TABLE "ClientData" MODIFY "ID" DEFAULT (SYS_GUID())
/
ALTER TABLE "History" MODIFY "Id" DEFAULT (SYS_GUID())
/
ALTER TABLE "History" MODIFY "ItemPath" DEFAULT ('')
/
ALTER TABLE "History" MODIFY "TaskStack" DEFAULT ('')
/
ALTER TABLE "History" MODIFY "AdditionalInfo" DEFAULT ('')
/
ALTER TABLE "IDTable" MODIFY "ID" DEFAULT (SYS_GUID())
/
ALTER TABLE "Links" MODIFY "ID" DEFAULT (SYS_GUID())
/
ALTER TABLE "Links" MODIFY "SourceLanguage" DEFAULT ('')
/
ALTER TABLE "Links" MODIFY "SourceVersion" DEFAULT ((0))
/
ALTER TABLE "Links" MODIFY "TargetLanguage" DEFAULT ('')
/
ALTER TABLE "Links" MODIFY "TargetVersion" DEFAULT ((0))
/
ALTER TABLE "Properties" MODIFY "ID" DEFAULT (SYS_GUID())
/
ALTER TABLE "PublishQueue" MODIFY "ID" DEFAULT (SYS_GUID())
/
ALTER TABLE "PublishQueue" MODIFY "Language" DEFAULT ('en')
/
ALTER TABLE "PublishQueue" MODIFY "Version" DEFAULT (1)
/
ALTER TABLE "PublishQueue" MODIFY "Action" DEFAULT ('')
/
ALTER TABLE "Shadows" MODIFY "ID" DEFAULT (SYS_GUID())
/
ALTER TABLE "SharedFields" MODIFY "Id" DEFAULT (SYS_GUID())
/
ALTER TABLE "UnversionedFields" MODIFY "Id" DEFAULT (SYS_GUID())
/
ALTER TABLE "VersionedFields" MODIFY "Id" DEFAULT (SYS_GUID())
/
ALTER TABLE "WorkflowHistory" MODIFY "ID" DEFAULT (SYS_GUID())
/
/
