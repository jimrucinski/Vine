...
// 		$args['p'] = urlencode(base64_encode($password));
	...
	private function connect($email, $password) {
		...
		// The 'password' encoded here is the updraftplus.com password. See here: http://updraftplus.com/faqs/tell-me-about-my-updraftplus-com-account/. Note - it may be empty if the user removed their password.
